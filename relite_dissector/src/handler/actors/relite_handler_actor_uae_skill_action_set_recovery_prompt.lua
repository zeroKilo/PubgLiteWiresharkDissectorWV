...
local handler={ClassName="UAESkillAction_SetRecoveryPrompt",ClassPath="/Script/ShadowTrackerExtra.UAESkillAction_SetRecoveryPrompt",SuperClass="UAESkillAction"}
