...
local handler={ClassName="FoliageInstancedStaticMeshComponent",ClassPath="/Script/Foliage.FoliageInstancedStaticMeshComponent",SuperClass="HierarchicalInstancedStaticMeshComponent"}
