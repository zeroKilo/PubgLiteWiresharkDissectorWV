...
local handler={ClassName="STEShootWeaponInstantComponent",ClassPath="/Script/ShadowTrackerExtra.STEShootWeaponInstantComponent",SuperClass="STExtraShootWeaponComponent"}
