...
local handler={ClassName="STCharacterMovementComponent",ClassPath="/Script/ShadowTrackerExtra.STCharacterMovementComponent",SuperClass="CharacterMovementComponent"}
