...
local handler={ClassName="UAESkillCondition_VehicleDriver",ClassPath="/Script/ShadowTrackerExtra.UAESkillCondition_VehicleDriver",SuperClass="UAESkillCondition"}
