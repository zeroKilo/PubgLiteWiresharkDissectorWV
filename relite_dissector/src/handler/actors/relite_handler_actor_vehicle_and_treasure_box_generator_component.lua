...
local handler={ClassName="VehicleAndTreasureBoxGeneratorComponent",ClassPath="/Script/Gameplay.VehicleAndTreasureBoxGeneratorComponent",SuperClass="BaseGeneratorComponent"}
