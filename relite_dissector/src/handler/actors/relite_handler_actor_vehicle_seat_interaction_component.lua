...
local handler={ClassName="VehicleSeatInteractionComponent",ClassPath="/Script/ShadowTrackerExtra.VehicleSeatInteractionComponent",SuperClass="SceneInteractionComponent"}
