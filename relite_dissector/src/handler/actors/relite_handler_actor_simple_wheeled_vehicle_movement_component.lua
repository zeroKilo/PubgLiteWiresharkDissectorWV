...
local handler={ClassName="SimpleWheeledVehicleMovementComponent",ClassPath="/Script/PhysXVehicles.SimpleWheeledVehicleMovementComponent",SuperClass="WheeledVehicleMovementComponent"}
