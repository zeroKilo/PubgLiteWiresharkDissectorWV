...
local handler={ClassName="SphereReflectionCaptureComponent",ClassPath="/Script/Engine.SphereReflectionCaptureComponent",SuperClass="ReflectionCaptureComponent"}
