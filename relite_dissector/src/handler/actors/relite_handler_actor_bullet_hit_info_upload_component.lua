...
local handler={ClassName="BulletHitInfoUploadComponent",ClassPath="/Script/ShadowTrackerExtra.BulletHitInfoUploadComponent",SuperClass="WeaponLogicBaseComponent"}
