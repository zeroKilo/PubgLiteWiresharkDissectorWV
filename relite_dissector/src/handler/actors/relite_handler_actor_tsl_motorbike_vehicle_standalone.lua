...
local handler={ClassName="TslMotorbikeVehicle_Standalone",ClassPath="/Script/ShadowTrackerExtra.TslMotorbikeVehicle_Standalone",SuperClass="TslMotorbikeVehicle"}
