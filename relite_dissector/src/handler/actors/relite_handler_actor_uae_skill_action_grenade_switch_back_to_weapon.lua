...
local handler={ClassName="UAESkillAction_GrenadeSwitchBackToWeapon",ClassPath="/Script/ShadowTrackerExtra.UAESkillAction_GrenadeSwitchBackToWeapon",SuperClass="UAESkillAction"}
