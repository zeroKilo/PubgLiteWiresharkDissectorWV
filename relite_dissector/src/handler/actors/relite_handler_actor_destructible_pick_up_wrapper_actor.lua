...
local handler={ClassName="DestructiblePickUpWrapperActor",ClassPath="/Script/ShadowTrackerExtra.DestructiblePickUpWrapperActor",SuperClass="PickUpWrapperActor"}
