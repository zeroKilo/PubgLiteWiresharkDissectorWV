...
local handler={ClassName="CharacterInteractionComponent",ClassPath="/Script/ShadowTrackerExtra.CharacterInteractionComponent",SuperClass="InteractionComponentTsl"}
