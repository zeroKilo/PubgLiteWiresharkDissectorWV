...
local handler={ClassName="STEShootWeaponProjectComponent",ClassPath="/Script/ShadowTrackerExtra.STEShootWeaponProjectComponent",SuperClass="STExtraShootWeaponComponent"}
