...
local handler={ClassName="STExtraBuffAction_DrowningDamage",ClassPath="/Script/ShadowTrackerExtra.STExtraBuffAction_DrowningDamage",SuperClass="UTSkillAction"}
