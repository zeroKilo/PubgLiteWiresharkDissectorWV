...
local handler={ClassName="HierarchicalInstancedStaticMeshComponent",ClassPath="/Script/Engine.HierarchicalInstancedStaticMeshComponent",SuperClass="InstancedStaticMeshComponent"}
