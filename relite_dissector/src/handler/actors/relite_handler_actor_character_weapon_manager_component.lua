...
local handler={ClassName="CharacterWeaponManagerComponent",ClassPath="/Script/ShadowTrackerExtra.CharacterWeaponManagerComponent",SuperClass="WeaponManagerComponent"}
