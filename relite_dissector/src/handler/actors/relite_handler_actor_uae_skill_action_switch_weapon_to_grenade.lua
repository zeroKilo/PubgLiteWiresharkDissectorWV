...
local handler={ClassName="UAESkillAction_SwitchWeaponToGrenade",ClassPath="/Script/ShadowTrackerExtra.UAESkillAction_SwitchWeaponToGrenade",SuperClass="UAESkillAction"}
