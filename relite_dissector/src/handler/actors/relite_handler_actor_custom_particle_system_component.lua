...
local handler={ClassName="CustomParticleSystemComponent",ClassPath="/Script/ShadowTrackerExtra.CustomParticleSystemComponent",SuperClass="ParticleSystemComponent"}
