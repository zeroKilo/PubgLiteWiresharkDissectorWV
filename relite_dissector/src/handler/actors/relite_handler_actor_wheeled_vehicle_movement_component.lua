...
local handler={ClassName="WheeledVehicleMovementComponent",ClassPath="/Script/PhysXVehicles.WheeledVehicleMovementComponent",SuperClass="PawnMovementComponent"}
