...
local handler={ClassName="STExtraBuffAction_EnableAttrModifier",ClassPath="/Script/ShadowTrackerExtra.STExtraBuffAction_EnableAttrModifier",SuperClass="UAESkillAction"}
