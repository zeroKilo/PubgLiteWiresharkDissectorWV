...
local handler={ClassName="WheeledVehicleMovementComponent4W",ClassPath="/Script/PhysXVehicles.WheeledVehicleMovementComponent4W",SuperClass="WheeledVehicleMovementComponent"}
