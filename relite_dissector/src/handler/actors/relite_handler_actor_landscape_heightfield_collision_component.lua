...
local handler={ClassName="LandscapeHeightfieldCollisionComponent",ClassPath="/Script/Landscape.LandscapeHeightfieldCollisionComponent",SuperClass="PrimitiveComponent"}
