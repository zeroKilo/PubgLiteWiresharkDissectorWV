...
local handler={ClassName="UAESkillAction_AddRecoveryPrompt",ClassPath="/Script/ShadowTrackerExtra.UAESkillAction_AddRecoveryPrompt",SuperClass="UAESkillAction"}
