...
local handler={ClassName="DelayFlyProjMovementComponent",ClassPath="/Script/ShadowTrackerExtra.DelayFlyProjMovementComponent",SuperClass="ProjectileMovementComponent"}
