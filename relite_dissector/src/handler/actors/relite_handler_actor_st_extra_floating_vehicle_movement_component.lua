...
local handler={ClassName="STExtraFloatingVehicleMovementComponent",ClassPath="/Script/ShadowTrackerExtra.STExtraFloatingVehicleMovementComponent",SuperClass="PawnMovementComponent"}
