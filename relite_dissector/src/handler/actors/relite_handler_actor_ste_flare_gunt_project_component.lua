...
local handler={ClassName="STEFlareGuntProjectComponent",ClassPath="/Script/ShadowTrackerExtra.STEFlareGuntProjectComponent",SuperClass="STEShootWeaponProjectComponent"}
