...
local handler={ClassName="CarepackageMovementComponent",ClassPath="/Script/ShadowTrackerExtra.CarepackageMovementComponent",SuperClass="ProjectileMovementComponent"}
