...
local handler={ClassName="LandscapeMeshCollisionComponent",ClassPath="/Script/Landscape.LandscapeMeshCollisionComponent",SuperClass="LandscapeHeightfieldCollisionComponent"}
