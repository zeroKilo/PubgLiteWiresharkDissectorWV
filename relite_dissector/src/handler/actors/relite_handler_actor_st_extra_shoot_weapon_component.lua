...
local handler={ClassName="STExtraShootWeaponComponent",ClassPath="/Script/ShadowTrackerExtra.STExtraShootWeaponComponent",SuperClass="WeaponLogicBaseComponent"}
