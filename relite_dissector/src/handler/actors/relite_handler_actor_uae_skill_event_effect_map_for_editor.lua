...
local handler={ClassName="UAESkillEventEffectMapForEditor",ClassPath="/Script/ShadowTrackerExtra.UAESkillEventEffectMapForEditor",SuperClass="UTSkillEventEffectMapForEditor"}
