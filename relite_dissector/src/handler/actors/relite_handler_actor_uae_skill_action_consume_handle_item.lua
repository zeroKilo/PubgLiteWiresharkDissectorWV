...
local handler={ClassName="UAESkillAction_ConsumeHandleItem",ClassPath="/Script/ShadowTrackerExtra.UAESkillAction_ConsumeHandleItem",SuperClass="UAESkillAction"}
