...
local maker={ClassName="CarepackageMovementComponent",ClassPath="/Script/ShadowTrackerExtra.CarepackageMovementComponent",SuperClass="ProjectileMovementComponent"}
