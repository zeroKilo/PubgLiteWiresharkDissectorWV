...
local maker={ClassName="TslMotorbikeVehicle_Standalone",ClassPath="/Script/ShadowTrackerExtra.TslMotorbikeVehicle_Standalone",SuperClass="TslMotorbikeVehicle"}
