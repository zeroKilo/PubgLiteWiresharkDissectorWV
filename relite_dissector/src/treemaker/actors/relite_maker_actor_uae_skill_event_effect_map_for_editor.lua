...
local maker={ClassName="UAESkillEventEffectMapForEditor",ClassPath="/Script/ShadowTrackerExtra.UAESkillEventEffectMapForEditor",SuperClass="UTSkillEventEffectMapForEditor"}
