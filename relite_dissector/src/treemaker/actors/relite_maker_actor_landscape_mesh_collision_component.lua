...
local maker={ClassName="LandscapeMeshCollisionComponent",ClassPath="/Script/Landscape.LandscapeMeshCollisionComponent",SuperClass="LandscapeHeightfieldCollisionComponent"}
