...
local maker={ClassName="FoliageInstancedStaticMeshComponent",ClassPath="/Script/Foliage.FoliageInstancedStaticMeshComponent",SuperClass="HierarchicalInstancedStaticMeshComponent"}
