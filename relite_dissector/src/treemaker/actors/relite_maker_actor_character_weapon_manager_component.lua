...
local maker={ClassName="CharacterWeaponManagerComponent",ClassPath="/Script/ShadowTrackerExtra.CharacterWeaponManagerComponent",SuperClass="WeaponManagerComponent"}
