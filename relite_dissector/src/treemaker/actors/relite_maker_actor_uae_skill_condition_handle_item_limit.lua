...
local maker={ClassName="UAESkillCondition_HandleItemLimit",ClassPath="/Script/ShadowTrackerExtra.UAESkillCondition_HandleItemLimit",SuperClass="UAESkillCondition"}
