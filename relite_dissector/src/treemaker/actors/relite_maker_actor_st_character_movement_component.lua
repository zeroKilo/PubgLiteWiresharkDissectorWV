...
local maker={ClassName="STCharacterMovementComponent",ClassPath="/Script/ShadowTrackerExtra.STCharacterMovementComponent",SuperClass="CharacterMovementComponent"}
