...
local maker={ClassName="CustomParticleSystemComponent",ClassPath="/Script/ShadowTrackerExtra.CustomParticleSystemComponent",SuperClass="ParticleSystemComponent"}
