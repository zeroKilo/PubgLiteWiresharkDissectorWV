...
local maker={ClassName="LandscapeHeightfieldCollisionComponent",ClassPath="/Script/Landscape.LandscapeHeightfieldCollisionComponent",SuperClass="PrimitiveComponent"}
