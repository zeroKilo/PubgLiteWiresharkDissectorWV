...
local maker={ClassName="VehicleAndTreasureBoxGeneratorComponent",ClassPath="/Script/Gameplay.VehicleAndTreasureBoxGeneratorComponent",SuperClass="BaseGeneratorComponent"}
