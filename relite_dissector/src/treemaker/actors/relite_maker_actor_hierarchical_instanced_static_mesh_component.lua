...
local maker={ClassName="HierarchicalInstancedStaticMeshComponent",ClassPath="/Script/Engine.HierarchicalInstancedStaticMeshComponent",SuperClass="InstancedStaticMeshComponent"}
