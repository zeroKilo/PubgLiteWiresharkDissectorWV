...
local maker={ClassName="STExtraBuffAction_AdjustStunPostMat",ClassPath="/Script/ShadowTrackerExtra.STExtraBuffAction_AdjustStunPostMat",SuperClass="UTSkillAction"}
