...
local maker={ClassName="DelayFlyProjMovementComponent",ClassPath="/Script/ShadowTrackerExtra.DelayFlyProjMovementComponent",SuperClass="ProjectileMovementComponent"}
