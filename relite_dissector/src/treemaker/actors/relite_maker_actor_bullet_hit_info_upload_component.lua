...
local maker={ClassName="BulletHitInfoUploadComponent",ClassPath="/Script/ShadowTrackerExtra.BulletHitInfoUploadComponent",SuperClass="WeaponLogicBaseComponent"}
