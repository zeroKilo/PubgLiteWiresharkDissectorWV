...
local maker={ClassName="STExtraVehicleMovementComponent4W",ClassPath="/Script/ShadowTrackerExtra.STExtraVehicleMovementComponent4W",SuperClass="WheeledVehicleMovementComponent4W"}
