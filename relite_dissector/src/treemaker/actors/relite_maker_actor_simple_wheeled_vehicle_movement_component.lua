...
local maker={ClassName="SimpleWheeledVehicleMovementComponent",ClassPath="/Script/PhysXVehicles.SimpleWheeledVehicleMovementComponent",SuperClass="WheeledVehicleMovementComponent"}
