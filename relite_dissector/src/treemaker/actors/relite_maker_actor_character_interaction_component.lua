...
local maker={ClassName="CharacterInteractionComponent",ClassPath="/Script/ShadowTrackerExtra.CharacterInteractionComponent",SuperClass="InteractionComponentTsl"}
