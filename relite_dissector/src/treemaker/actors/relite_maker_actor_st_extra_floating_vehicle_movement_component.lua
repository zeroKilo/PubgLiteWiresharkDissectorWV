...
local maker={ClassName="STExtraFloatingVehicleMovementComponent",ClassPath="/Script/ShadowTrackerExtra.STExtraFloatingVehicleMovementComponent",SuperClass="PawnMovementComponent"}
