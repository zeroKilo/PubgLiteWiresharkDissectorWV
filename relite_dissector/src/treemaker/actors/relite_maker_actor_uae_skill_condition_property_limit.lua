...
local maker={ClassName="UAESkillCondition_PropertyLimit",ClassPath="/Script/ShadowTrackerExtra.UAESkillCondition_PropertyLimit",SuperClass="UAESkillCondition"}
