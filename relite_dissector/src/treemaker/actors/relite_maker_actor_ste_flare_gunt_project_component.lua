...
local maker={ClassName="STEFlareGuntProjectComponent",ClassPath="/Script/ShadowTrackerExtra.STEFlareGuntProjectComponent",SuperClass="STEShootWeaponProjectComponent"}
