...
local maker={ClassName="STEShootWeaponProjectComponent",ClassPath="/Script/ShadowTrackerExtra.STEShootWeaponProjectComponent",SuperClass="STExtraShootWeaponComponent"}
